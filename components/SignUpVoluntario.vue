         ...
         <v-form ref="form" v-model="valid" >
                <v-card>
                    ...
                    <v-card-text>
                        ...
                        <v-text-field v-model="contraseña2" required placeholder="Repetir contraseña" type="password"></v-text-field>
                        ...
                        <v-btn block @click="validate" to="/voluntario/sesion">Enviar</v-btn>
                    </v-card-text>
                </v-card>    
        </v-form>  
    </div>
